...
set :domain, 'galaxy2.kbb1.com'
set :deploy_to, '/sites/galaxy2/rails'
set :repository, 'git@github.com:Bnei-Baruch/galaxy2.git'
set :branch, 'master'
...
set :shared_paths, %w(config/mongoid.yml config/secrets.yml config/thin.yml log)
...
task :setup => :environment do
  ...
  queue  %[echo "-----> Be sure to edit '#{deploy_to}/#{shared_path}/config/mongoid.yml', 'secrets.yml' and 'thin.yml'."]
